...
def test_split_chapter_intelligently_basic(tmp_path):
    ...
    split_chapter_intelligently(str(chapter_file), str(output_dir), target_chars=50, max_part_chars=100)
...
def test_split_chapter_intelligently_scene_marker(tmp_path):
    ...
    split_chapter_intelligently(str(chapter_file), str(output_dir), target_chars=40, max_part_chars=100)
